class Worker
  attr_reader :name, :number_of_childrens, :group, :total_salary

  def initialize(name: ,number_of_childrens:, group: )
    @name = name
  ...
  def child_support
    number_of_childrens <= 3 ? number_of_childrens * 50 : 150
  end
...
class PermanentWorker < Worker
  ...
  def initialize(name: ,group: ,number_of_childrens: 0)
    super(name: name, group: group, number_of_childrens: number_of_childrens)
...
class ContractWorker < Worker
  ...
  def initialize(name: ,group: ,number_of_childrens: 0)
    super(name: name, number_of_childrens: number_of_childrens, group: group)
...
puts "ContractWorker"
puts "--------------------------------"
@john = ContractWorker.new(name: "John",group: "A",number_of_childrens: 2)
@john.count_total_salary
@john.print_salary
puts
puts "PermanentWorker"
puts "--------------------------------"
@bill = PermanentWorker.new(name: "Bill",group: "E",number_of_childrens: 5)
